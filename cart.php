                    ...
                    <div class="w-100 px-1" v-for="(item, index) in cartItems" :key="index">                                     
                      ...
                      <div class="w-100 items-center hover:bg-gray-100 -mx-8 px-6 py-5">                          
                        <div class="flex w-5/5 pb-1">
                          <span class="font-bold text-sm">{{ product.node.title }} -- {{  item.node.merchandise.title.replace('Default', '') }}</span>
                        </div>
                        <div class="flex items-center">
                          <div class="flex w-2/5"> 
                            ...
                            <div class="flex flex-col justify-between ml-4 flex-grow">                            
                              <span class="text-red-500 text-xs">{{ item.node.merchandise.title.replace('Default', '') }}</span>
                              <!-- Remove icon >> ################################################################ -->
